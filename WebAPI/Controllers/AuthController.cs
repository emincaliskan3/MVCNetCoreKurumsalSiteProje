...
namespace WebAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult> LoginAsync(LoginViewModel loginViewModel)
        {
            ...
            // Eğer rol sistemi kullanıcaksak
            ...
            // Giriş yapan kullanıcıya içine doldurup göndereceğimiz token nesnesi
            ...
            // Token oluşturucu sınıfından örnek oluşturuyoruz
            ...
            // token UserGuid i giriş yapan kullanıcınınkiyle eşleştiriyoruz
