...
{
    x.AddPolicy("AdminPolicy", policy => policy.RequireClaim(ClaimTypes.Role, "Admin", "SuperAdmin")); // AdminPolicy yetkisiyle giriþ yapan Admin ve SuperAdmin yetkili kullanýcýlar AdminPolicy kullanýlan ekranlara eriþebilirler. Diðer "User","Personal" vb yetkisiyle giriþ yapanlar bu ekrana eriþemezler
...
// kendi yazdýðýmýz servisi aþaðýdaki þekilde uygulamaya tanýtýyoruz, yoksa çalýþmýyor!!
