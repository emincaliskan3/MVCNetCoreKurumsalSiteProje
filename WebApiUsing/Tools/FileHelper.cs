        ...
        public static async Task<MultipartFormDataContent> ApiFileSenderAsync(IFormFile? formFile)
        {
            ...
            if (formFile != null && formFile.Length > 0) // apiye gönderilmek istenen dosyayı kontrol ettik
            {
                ...
                content.Headers.ContentType = new
                    ...
                    (formFile.ContentType); // content nesnesinin http başlık istek kısmına yüklemek istediğimiz dosya tipini ekledik
                formData.Add(content, "formFile", formFile.FileName); // sonra sunucuya yüklemek istediğimiz byte veri tipini content nesnesine ekledik, yüklenen dosyaya formFile ismini verdik ve dosya adını ekledik 
            }
