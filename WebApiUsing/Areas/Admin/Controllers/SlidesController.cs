...
namespace WebApiUsing.Areas.Admin.Controllers
{
    ...
    public class SlidesController : Controller
    {
        ...
        string _apiAdres = "https://localhost:7188/api/Slides/";

        string _apiAdres2 = "https://localhost:7188/api/Upload/";
        ...
        public async Task<ActionResult> CreateAsync(Slide collection, IFormFile? Image)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //var forDataresponse = await _httpClient.PostAsJsonAsync(_apiAdres2, FileHelper.ApiFileSenderAsync(Image));
                    ...
                    //System.Net.Http.Headers.MediaTypeHeaderValue(Image.ContentType);
