...
namespace Entities
{
    public class Cart
    {
        ...
        {
            return products.Sum(i => i.Product.Price * i.Quantity); // sepetteki ürünlerin toplam tutarını dönecek olan metot. Ürün fiyatıyla miktarı çaptırıp döndük.
        }
        public void ClearAll() //Sepetteki boşalt metodu
        {
